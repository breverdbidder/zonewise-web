  ...
  return (
    ...
    >
      <button
        ...
        className="w-full flex items-center justify-between px-5 py-4 bg-gray-50 dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-[rgb(var(--zw-elev)/0.7)] transition-colors text-left print:pointer-events-none"
        aria-expanded={open}
      >
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-[rgb(var(--zw-elev)/0.1)] dark:bg-[#1B2737]/20 flex items-center justify-center flex-shrink-0">
            <Icon className="w-4 h-4 text-[rgb(var(--zw-ink2))] dark:text-[#1A90FF]" />
          </div>
          <span className="font-semibold text-gray-900 dark:text-white text-sm">{title}</span>
          {badge && (
            <span className="text-xs px-2 py-0.5 rounded-full bg-[rgb(var(--zw-brand)/0.15)] text-[rgb(var(--zw-brand))] font-medium">
              {badge}
            </span>
          )}
        </div>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6 font-sans print:px-0 print:py-0 print:max-w-none">
      ...
      <div className="hidden print:flex items-center justify-between mb-6 pb-4 border-b border-gray-200">
        <div>
          <p className="text-lg font-bold text-[rgb(var(--zw-ink2))]">ZoneWise.AI</p>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6 print:mb-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-3 mb-3">
            ...
            <div className="flex gap-2 print:hidden flex-shrink-0">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-[rgb(var(--zw-border2))] text-[rgb(var(--zw-ink2))] dark:border-[#1A90FF] dark:text-[#1A90FF] text-xs font-medium hover:bg-[rgb(var(--zw-elev)/0.05)] dark:hover:bg-[rgb(var(--zw-brand)/0.05)] transition-colors"
              >
              ...
              <button
                onClick={handleShare}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-gray-300 dark:border-slate-600 text-gray-600 dark:text-slate-300 text-xs font-medium hover:bg-gray-50 dark:hover:bg-[rgb(var(--zw-elev))] transition-colors"
              >
          ...
          <div className="flex flex-wrap gap-2">
            <span className="inline-flex items-center gap-1 text-xs px-2.5 py-1 rounded-full bg-[rgb(var(--zw-elev)/0.1)] dark:bg-[#1B2737]/20 text-[rgb(var(--zw-ink2))] dark:text-blue-300 font-medium">
      ...
      <Section id="ai-analysis" icon={Brain} title="AI Zoning Analysis" badge="ZoneWise Advantage" defaultOpen={true}>
        <div className="space-y-3">
          <div className="text-sm text-gray-700 dark:text-slate-300 leading-relaxed whitespace-pre-wrap bg-[rgb(var(--zw-elev)/0.03)] dark:bg-slate-800/60 rounded-lg p-4">
            {ai.summary}
          </div>
          ...
          {zi.code_link && (
            <div className="flex justify-between items-center py-2">
              ...
              <a
                ...
                className="text-sm text-[rgb(var(--zw-brand))] hover:underline flex items-center gap-1"
              >
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-start">
          <div className="flex-1">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[rgb(var(--zw-brand))] hover:bg-[rgb(var(--zw-brand))]/80 text-white text-sm font-medium transition-colors print:hidden"
            >
          ...
          {mp.static_preview_url ? (
            ...
            <div className="w-full sm:w-48 h-36 rounded-lg bg-[rgb(var(--zw-elev)/0.1)] dark:bg-slate-800 flex flex-col items-center justify-center gap-2">
              <Box className="w-10 h-10 text-[rgb(var(--zw-ink2)/0.4)] dark:text-slate-500" />
      ...
      <Section id="ml-risk-score" icon={BarChart3} title="ML Risk Score" badge="Coming Soon" defaultOpen={false}>
        <div className="flex items-center gap-3 text-sm text-gray-500 dark:text-slate-400 bg-gray-50 dark:bg-slate-800/60 rounded-lg p-4">
          <AlertCircle className="w-5 h-5 text-[rgb(var(--zw-brand))] flex-shrink-0" />
          <div>
          ...
          <div>
            ...
            <div className="rounded-lg h-48 bg-slate-100 dark:bg-slate-800 flex flex-col items-center justify-center gap-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-xs text-[rgb(var(--zw-brand))] hover:underline flex items-center gap-1"
              >
