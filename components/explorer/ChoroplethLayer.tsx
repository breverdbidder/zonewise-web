  ...
  return (
    <div className="bg-[rgb(var(--zw-page)/0.9)] border border-[rgb(var(--zw-border2))] rounded-xl p-3 backdrop-blur-sm">
      ...
      <div className="flex items-center justify-between mb-2">
        <span className="text-[9px] font-bold text-[rgb(var(--zw-ink2))] uppercase tracking-wider">Heatmap</span>
        <label className="flex items-center gap-1.5 cursor-pointer">
          ...
          />
          <span className="text-[10px] text-[rgb(var(--zw-ink2))]">{visible ? 'On' : 'Off'}</span>
        </label>
      </div>
      ...
      <select
        ...
        className="w-full bg-[rgb(var(--zw-page))] border border-[rgb(var(--zw-border2))] rounded-md px-2 py-1.5 text-[11px] text-[rgb(var(--zw-ink))] focus:outline-none focus:border-amber-500/60 mb-2"
      >
        ...
        <div className="space-y-0.5">
          {legend.map(({ label, color }) => (
            <div key={label} className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] text-[rgb(var(--zw-ink2))]">{label}</span>
            </div>
          ))}
        </div>
      )}
