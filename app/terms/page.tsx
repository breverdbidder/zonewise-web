    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-slate">
          ...
          <p>ZoneWise.AI and ZoneWise.AI 2026 shall not be liable for any damages arising from the use of this service, including but not limited to direct, indirect, incidental, or consequential damages.</p>
