...
export default function TermsPage() {
  return (
    <div className="min-h-screen bg-white text-[rgb(var(--zw-ink))]">
      <div className="max-w-3xl mx-auto px-4 py-12">
        <Link href="/" className="text-[rgb(var(--zw-ink2))] hover:underline">← Back to home</Link>
        <h1 className="text-3xl font-bold mt-6 mb-8 text-[rgb(var(--zw-ink))]">Terms of Service</h1>
        <div className="prose prose-slate prose-gray">
          <p className="text-gray-700">Last updated: January 27, 2026</p>
          
          <h2 className="text-xl font-semibold mt-8 mb-4 text-[rgb(var(--zw-ink))]">1. Acceptance of Terms</h2>
          <p>By accessing ZoneWise.AI, you agree to be bound by these Terms of Service.</p>
          
          <h2 className="text-xl font-semibold mt-8 mb-4 text-[rgb(var(--zw-ink))]">2. Description of Service</h2>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4 text-[rgb(var(--zw-ink))]">3. Disclaimer of Warranties</h2>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4 text-[rgb(var(--zw-ink))]">4. Limitation of Liability</h2>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4 text-[rgb(var(--zw-ink))]">5. Not Legal Advice</h2>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4 text-[rgb(var(--zw-ink))]">6. User Responsibilities</h2>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4 text-[rgb(var(--zw-ink))]">7. Subscription and Billing</h2>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4 text-[rgb(var(--zw-ink))]">8. Contact</h2>
