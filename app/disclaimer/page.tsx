  ...
  return (
    <div className="min-h-screen bg-white text-[rgb(var(--zw-ink))]">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <h1 className="text-3xl font-bold mt-6 mb-8 text-[rgb(var(--zw-ink))]">Zoning Information Disclaimer</h1>
        ...
        <div className="prose prose-slate prose-gray">
          <h2 className="text-xl font-semibold mt-8 mb-4 text-[rgb(var(--zw-ink))]">No Guarantee of Accuracy</h2>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4 text-[rgb(var(--zw-ink))]">Not Legal or Professional Advice</h2>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4 text-[rgb(var(--zw-ink))]">Always Verify with Official Sources</h2>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4 text-[rgb(var(--zw-ink))]">Limitation of Liability</h2>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4 text-[rgb(var(--zw-ink))]">User Acknowledgment</h2>
