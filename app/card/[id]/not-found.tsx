...
export default function ParcelNotFound() {
  return (
    <main style={{
      background: 'rgb(var(--zw-page))', color: '#F1F5F9', minHeight: '100vh',
      fontFamily: 'Inter, system-ui, sans-serif',
      display: 'flex', alignItems: 'center', justifyContent: 'center',
    }}>
      <div style={{ maxWidth: 520, padding: '48px 24px', textAlign: 'center' }}>
        <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgb(var(--zw-brand))', marginBottom: 16 }}>
          404 · Card not found
        </div>
